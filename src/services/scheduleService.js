  ...
  try {
    ...
    if (currentHour >= 23) {
      ...
      if (tomorrowDailyCount < 25) {
        console.log(`[AutoScheduler] It is past 11:00 PM and tomorrow (${tomorrow}) has ${tomorrowDailyCount}/25 matches. Auto-generating 25 sequential matches for tomorrow...`);
