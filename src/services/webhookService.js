...
const DEFAULT_MAKE_WEBHOOK_URL = 'https://hook.eu1.make.com/d7lav19d6j4mxvuittql3pkdb8vwzs55';

export const getWebhookUrl = () => {
  return localStorage.getItem(WEBHOOK_STORAGE_KEY) || DEFAULT_MAKE_WEBHOOK_URL;
};
