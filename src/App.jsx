...
import { checkAndAutoGenerateDailyMatches, setupDaily11PmScheduleTimer } from './services/scheduleService';
import './App.css';
...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Auto-check and setup 11:00 PM daily scheduler for 1v1 matches
    checkAndAutoGenerateDailyMatches();
    const cleanupScheduleTimer = setupDaily11PmScheduleTimer();
