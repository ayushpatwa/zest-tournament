...
import { checkAndAutoGenerateDailyMatches, setupDaily1030PmScheduleTimer } from './services/scheduleService';
import './App.css';
...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Auto-check and setup 10:30 PM daily scheduler for 1v1 matches
    checkAndAutoGenerateDailyMatches();
    const cleanupScheduleTimer = setupDaily1030PmScheduleTimer();

    return () => {
      unsubscribeTourneys();
      unsubscribeNotifs();
      unsubscribeSettings();
      if (cleanupScheduleTimer) cleanupScheduleTimer();
    };
  }, []);
